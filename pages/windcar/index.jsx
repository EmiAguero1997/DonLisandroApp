    ...
    return (
        <div>
            ...
            <div style={{ textAlign: 'center' }}>
                ...
                <h4>ACTIVIDAD</h4>
                <p>Instrucción personalizada para iniciarse en la navegación en tierra (land Sailing).
                    Conduciendo un blokart, carros de última generación, diseñados específicamente para rentals e instrucciones.
                </p>
                <h4>SEGURIDAD</h4>
                ...
                <p>PAMPA EL LEONCITO (18 kms. de Barreal)
                    ...
                    y un paisaje increíble! (Al pie de Los Andes)
                </p>
                <h4>Asistencia permanente del Instructor</h4>
                <p>HORARIO DE LA ACTIVIDAD
                    18hs. hasta las 20hs.
                    Está incluído el registro fotografico durante la actividad.
                </p>
            </div>
